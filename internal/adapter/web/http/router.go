...
curl -X POST http://localhost:8080/catalogue/film/regular -H "Content-Type: application/json" -d '{"name":"Loki", "director":"Marvel"}'
curl -X POST http://localhost:8080/catalogue/film/old -H "Content-Type: application/json" -d '{"name":"Loki", "director":"Marvel"}'
